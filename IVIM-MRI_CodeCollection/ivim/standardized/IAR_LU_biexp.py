...
from ivim.wrappers.OsipiBase import OsipiBase
from ivim.original.IAR_LundUniversity.ivim_fit_method_biexp import IvimModelBiExp
...
class IAR_LU_biexp(OsipiBase):
    ...
    def ivim_fit(self, signals, bvalues, **kwargs):
        ...
        if self.IAR_algorithm is None:
            ...
            bvec[:,2] = 1
            gtab = gradient_table(bvals=bvalues, bvecs=bvec, b0_threshold=0)
